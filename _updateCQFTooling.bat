...
SET "dlurl=https://oss.sonatype.org/service/local/artifact/maven/redirect?r=snapshots&g=org.opencds.cqf&a=tooling&v=1.3.1&c=jar-with-dependencies"
SET tooling_jar=tooling-1.3.1-jar-with-dependencies.jar
